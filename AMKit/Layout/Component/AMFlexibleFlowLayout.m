...
@interface AMFlexibleFlowLayout ()

@property (nonatomic, strong) NSMutableArray<UICollectionViewLayoutAttributes *> *decorationViewAttributes;

@end

@implementation AMFlexibleFlowLayout

- (void)prepareLayout {
    [super prepareLayout];
    
    id<AMFlexibleFlowLayoutDelegate> delegate = (id<AMFlexibleFlowLayoutDelegate>)self.collectionView.delegate;
    ...
    [self registerClass:[AMFlexibleReusableView class] forDecorationViewOfKind:@"AMFlexibleReusableView"];
    ...
    for (NSInteger section = 0; section < [self.collectionView numberOfSections]; section++) {
        ...
        // 配置
        AMFlexibleLayoutAttributes *attribute = [AMFlexibleLayoutAttributes layoutAttributesForDecorationViewOfKind:@"AMFlexibleReusableView" withIndexPath:[NSIndexPath indexPathForRow:0 inSection:section]];
