...
/// 插入section
am_property_copy AMFlexChainViewInsertModel *(^insertSection)(NSInteger tag);

/// 获取/编辑section （可清空、获取数据源等）
am_property_copy AMFLEXChainViewEditModel *(^sectionForTag)(NSInteger tag);
...
/// 插入cell
am_property_copy AMFlexibleInsertSectionModel *(^ insertCell)(NSString *className);
/// 批量插入cell
