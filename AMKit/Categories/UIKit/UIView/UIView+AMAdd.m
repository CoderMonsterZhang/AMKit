...
- (UINavigationController *)am_navigationController
{
    return self.am_viewController.navigationController;
}

- (void)am_setLayerShadow:(UIColor*)color offset:(CGSize)offset radius:(CGFloat)radius {
...
- (UIViewController *)am_viewController {
...
- (CGPoint)am_convertPoint:(CGPoint)point toViewOrWindow:(UIView *)view {
    if (!view) {
        if ([self isKindOfClass:[UIWindow class]]) {
...
- (CGPoint)am_convertPoint:(CGPoint)point fromViewOrWindow:(UIView *)view {
    if (!view) {
        if ([self isKindOfClass:[UIWindow class]]) {
...
- (CGRect)am_convertRect:(CGRect)rect toViewOrWindow:(UIView *)view {
    if (!view) {
        if ([self isKindOfClass:[UIWindow class]]) {
...
- (CGRect)am_convertRect:(CGRect)rect fromViewOrWindow:(UIView *)view {
    if (!view) {
        if ([self isKindOfClass:[UIWindow class]]) {
