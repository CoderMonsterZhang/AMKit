...
MasSYNTH_DUMMY_CLASS(UIControl_YYAdd)


static const int block_key;

@interface _AMUIControlBlockTarget : NSObject
...
@implementation _AMUIControlBlockTarget
...
@implementation UIControl (AMAdd)
...
- (void)addBlockForControlEvents:(UIControlEvents)controlEvents
    ...
    _AMUIControlBlockTarget *target = [[_AMUIControlBlockTarget alloc]
...
- (void)removeAllBlocksForControlEvents:(UIControlEvents)controlEvents {
    ...
    for (_AMUIControlBlockTarget *target in targets) {
